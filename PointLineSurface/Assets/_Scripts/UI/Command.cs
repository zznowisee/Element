...
public class Command : MonoBehaviour, ISelectable
{
    ...
    void Awake()
    {
        ...
        draggingParent = FindObjectOfType<UI_OperateScene>().transform;
    ...
    void OnEnable() => UI_MouseManager.Instance.AddISelectableObj(this);
    void OnDisable() => UI_MouseManager.Instance.RemoveISelectableObj(this);
    public void SelectingVisual()
    {
        selecting.gameObject.SetActive(preSelected || selected);
    }
    ...
    public void LeftRelease(out bool destory)
    {
