            ...
            if (next != null)
            {
                ...
                if (reciever != null)
                {
                    ...
                    switch (commandType)
                    {
                        ...
                        case CommandType.PutDown: reciever.ExecutePutDownUp(RecieverFinishedCommand, executeTime, BrushState.PUTDOWN); break;
                        case CommandType.PutUp: reciever.ExecutePutDownUp(RecieverFinishedCommand, executeTime, BrushState.PUTUP); break;
